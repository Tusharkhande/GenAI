...
export default function HomeScreen () {
  ...
  const selectedAvatar = route.params?.selectedAvatar || user.photoURL || gUserAvatar;
  ...
  return (
    ...
    <SafeAreaView className="flex-1 font-mono flex justify-around bg-slate-950" style={{ width: wp(100), height: wp(100)}}>
      ...
      >
        ...
        <View className="flex mx-auto justify-center ">
          ...
          >
            ...
            Welcome {user.displayName ? user.displayName.split(" ")[0] : guser ? guser.displayName.split(" ")[0] : name.split(" ")[0]}!
          </Text>
        </View>
        <View>
          <View className='ml-3'>
      ...
      <TouchableOpacity
        onPress={() => [navigation.navigate('Chat', { selectedModel: selectedModel, selectedAvatar: selectedAvatar }), select_beep()]}
      ...
      <Modal visible={exit} animationType="fade" transparent>
                <View className='flex flex-1 bg-black/50 items-center justify-center self-center w-full'>
                    <View style={{ width: wp(80), height: wp(35) }}
                        ...
                        <Text className="font-mono text-base text-center text-slate-100 mb-5 mt-0">Are you sure you want to Exit?</Text>
                        <View className='flex flex-row justify-center self-center gap-8'>
                            ...
                            <View style={{ width: wp(20) }}
                                className="bg-slate-600 rounded-3xl flex justify-center text-center">
                                <Button title="No" textStyle={'text-sm'} onPress={() => [setExit(false), select_beep()]} />
                            </View>
                        </View>
                    </View>
                </View>
