...
export default TextCard = ({imageSource, text, color, onPress}) => {
  return (
    ...
    <TouchableOpacity onPress={onPress} className={`justify-center w-40 h-32 rounded-xl border-2 border-slate-900 dark:border-slate-200 bg-slate-300 dark:bg-slate-900 overflow-hidden`}>
